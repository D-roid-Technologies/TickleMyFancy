...
export default function ChooseYourVibe() {
  const vibeCards = [
    ...
    },
    {
      ...
      subtitle: "Slow dance in the living room or share secrets under the stars.",
      image: VIBE3,
    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-sm font-semibold text-purple-600 uppercase tracking-wider mb-4">CHOOSE YOUR VIBE</p>
            ...
            >
              <div className="bg-transparent rounded-2xl overflow-hidden">
                ...
                <div className="relative h-48 overflow-hidden rounded-[20px]">
                  <img src={card.image || "/placeholder.svg"} alt={card.title} className="w-[279px] h-[213px] object-cover" />
                </div>

                {/* Card Content */}
                <div className="p-6 text-center">
                  <h3 className="text-white font-bold text-lg mb-3">{card.title}</h3>
                  <p className="text-white/90 text-sm leading-relaxed">{card.subtitle}</p>
                </div>
              </div>
            </div>
          ))}
